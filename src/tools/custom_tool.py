...
# Existing example tool (kept for reference / future extension)
...
# ------------------------- New Tooling Suite ------------------------------ #
# Each tool returns concise, structured markdown so downstream LLM reasoning
# remains deterministic and easy to parse.
